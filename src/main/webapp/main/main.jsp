        ...
        $.ajax({
            ...
            success:function (data) {
                $.each(data,function (index,first) {
                    var c = "";
                    $.each(first.children,function (index1,sec) {
                        c += "<p style='text-align: center'><a href='#' class='easyui-linkbutton' onclick=\"addTabs('"+sec.menuTitle+"','"+sec.menuHref+"','"+sec.menuIconcls+"')\" data-options=\"iconCls:'icon-search'\">" + sec.menuTitle + "</a></p>";
                    })
...
<body class="easyui-layout">
    ...
    <div data-options="region:'center'">
    	<div id="tt" class="easyui-tabs" data-options="fit:true,narrow:true,pill:true">
		    <div title="主页" data-options="iconCls:'icon-neighbourhood',"  href="${pageContext.request.contextPath}/main/center.jsp"></div>
		</div>
    </div>
</body>
</html>